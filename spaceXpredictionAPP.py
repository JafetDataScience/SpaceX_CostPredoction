...
@app.callback(
    ...
    [State(component_id='flight-number', component_property='value'),
     ...
     State(component_id='block', component_property='value'),
     State(component_id='reused-count', component_property='value'),
     State(component_id='orbit-type', component_property='value'),
     State(component_id='launch-site', component_property='value'),
     State(component_id='landing-site', component_property='value'),
     State(component_id='version', component_property='value'),
     State(component_id='grid', component_property='value'),
